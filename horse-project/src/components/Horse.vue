...
<template>
    <div class="horse-svg" :style="{left:(props.horse.position/rounds[currentRound-1]?.distance)*100+'%'}">
        <div :class="{'horse-bounce':props.horse.position !==0}">

            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" :fill="horse.color" version="1.1"
            id="Capa_1" width="75px" height="75px" viewBox="0 0 213.825 213.825" xml:space="preserve">
            <g>
                <path
...
.horse-bounce {
 animation: gallop 0.6s infinite ease-in-out;
